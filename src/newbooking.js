...
class Newbooking extends Component{
    ...
    processRoom=(obj)=>{
        this.setState({
            ...
            due:this.state.roomlist[obj.target.value].price * this.state.days - this.state.paid
        })
    }
        ...
        return(
            <div className="container">
                    ...
                    <div className="col-md-6">
                        ...
                        <div className="border p-3">
                            <div className="form-group row">
                                ...
                                <div className="col-md-9"><input type="text" className="form-control" onChange={this.processName}/></div>
                            </div>
                            <div className="form-group row">
                                <div className="col-md-3">Mobile No</div>
                                <div className="col-md-9"><input type="text" className="form-control" onChange={this.processMobile}/></div>
                            </div>
                            <div className="form-group row">
                                <div className="col-md-3">E-Mail</div>
                                <div className="col-md-9"><input type="text" className="form-control" onChange={this.processEmail}/></div>
                            </div>
                            <div className="form-group row">
                                <div className="col-md-3">ID Proof</div>
                                <div className="col-md-9"><input type="text" className="form-control" onChange={this.processId}/></div>
                            </div>
                            <div className="form-group row">
                                <div className="col-md-3">Address</div>
                                <div className="col-md-9"><input type="text" className="form-control" onChange={this.processAddress}/></div>
                            </div>
                        </div>
                    </div>
                    <div className="col-md-6">
                                    ...
                                    <select className="form-control" onChange={this.processRoom}>
                                        <option>Select Room</option>
                                        {
                                            this.state.roomlist.map((myroom , index)=>{
                                                return <option key={index} value={index}>{myroom.roomno}-{myroom.price}</option>
                                            })
                                        }
                                    </select>
                                </div>
                ...
                <div className="row mt-3">
                    <div className="col-md-12 text-center">
                        <button className="btn btn-primary" onClick={this.save}>Book Now</button>
                    </div>
                </div>
            </div>
        );
